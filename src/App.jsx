...
const App = () => {
  return (
    <>
      ...
      <div id="projetos">
        <div className="mb-12 flex items-center justify-between">
          ...
          <ul className="flex gap-5 text-sm">
            <li className="cursor-pointer border border-neutral-600 flex justify-center items-center rounded-full px-4 pt-3 pb-2 text-neutral-400 font-astrid-light hover:bg-neutral-800">Todos os projetos</li>
            <li className="cursor-pointer border border-neutral-600 bg-neutral-800 flex justify-center items-center rounded-full px-4 pt-3 pb-2 text-neutral-400 font-astrid-light hover:bg-neutral-800">Selecionados</li>
            <li className="cursor-pointer border border-neutral-600 flex justify-center items-center rounded-full px-4 pt-3 pb-2 text-neutral-400 font-astrid-light hover:bg-neutral-800">Comerciais</li>
            <li className="cursor-pointer border border-neutral-600 flex justify-center items-center rounded-full px-4 pt-3 pb-2 text-neutral-400 font-astrid-light hover:bg-neutral-800">Musicais</li>
            <li className="cursor-pointer border border-neutral-600 flex justify-center items-center rounded-full px-4 pt-3 pb-2 text-neutral-400 font-astrid-light hover:bg-neutral-800">Eventos</li>
          </ul>
        </div>
      ...
      <div className="fixed top-0 left-0 pointer-events-none opacity-[.125] block h-screen w-screen bg-[url('/images/noise.gif')]"></div>
    </>
